...
import '../assets/Loan/EmiLoanForm.css';
...
export default function EmiLoanForm() {
    ...
    return (
      <div className="PersonalLoanForm-container">
        <h1>EMI Loan Application Form</h1>
          ...
          <section className="PersonalLoanForm-section">
            ...
            <div className="PersonalLoanForm-loan-options">
              <div className="PersonalLoanForm-form-group">
                <label htmlFor="loan-type">Choose Loan Type</label>
                <select
                  id="loan-type"
                  name="loanType"
                  value={loanType}
              ...
              <div className="PersonalLoanForm-form-group">
                <label htmlFor="loan-scheme"> Choose Loan Service</label>
                <select
                  id="loan-scheme"
                  name="loanScheme"
                  value={loanScheme}
                  ...
                  required
                >
                  <option value="" disabled>Select Loan Service</option>
